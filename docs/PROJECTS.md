...
- **GitHub organization:** [declarative-migrations-test](https://github.com/declarative-migrations-test)
- **Canonical GitHub Project:** [declarative-migrations-test-project](https://github.com/orgs/declarative-migrations-test/projects/1) (project 1)
- **Canonical Linear project:** [planning workspace](https://linear.app/denman/project/githubcomdeclarative-migrations-test-7e6b5d911bd8)
- **Organization documentation repository:** [declarative-migrations-test/.github](https://github.com/declarative-migrations-test/.github)
